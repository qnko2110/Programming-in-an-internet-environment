...
public class Animals3 {
    ...
    public static void main(String[] args) {
        ...
        final int NUM_OF_PIGS = 5;
        final int NUM_OF_COW = 5;
        ...
        // ------------------------------------------- Add cows to farm
        for (int i = 1; i <= NUM_OF_COW; i++) {
            String idValue = String.format("'BG S35 %08d'", i);
            int weightValue
                    = Utils.getRandomInRange(Utils.COW_MIN_WEIGHT,
                            Utils.COW_MAX_WEIGHT);
            String soundValue = "mooo";
...
class Utils {
    ...
    public final static int COW_MIN_WEIGHT = 140;
    public final static int COW_MAX_WEIGHT = 320;
